var editor_func = function()
{
        ...
        {  
            ...
            {   
            	...
            	// counter ===3 can never be reached for the last triplet, hence it's omitted
                if (counter === 3)
                {
                    counter = 0;
                    index++;
         ...
         * HERE 2
         */
        //loadFile("/Users/nkasch/Documents/HHP/example_processed_extraction_reformat.txt");
        //loadString("THIS IS A TEST \n ANOTHER")
        //loadString("Heinrich Glarean\nwas\na Swiss music theorist, poet and humanist\nHeinrich Glarean\nwas born\nin Mollis")
        processURLArgs()
        return{
